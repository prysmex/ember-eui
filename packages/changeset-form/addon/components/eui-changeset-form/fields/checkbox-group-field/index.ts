...
interface EuiChangesetFormCheckboxGroupFieldArgs extends BaseArgs {
  onChange?: (value: Values) => void;
}

export default class EuiChangesetFormCheckboxGroupField extends Base<EuiChangesetFormCheckboxGroupFieldArgs> {
