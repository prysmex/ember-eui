...
<EuiFlexGroup>
  <EuiFlexItem>
    ...
    >
      ...
      >
        {{#if this.wrapText}}
          First item with very long text with Lorem ipsum dolor sit amet, consectetur adipiscing elit
        {{else}}
          First item
        {{/if}}
      </EuiListGroupItem>
  ...
  <EuiFlexItem>
    <EuiFlexGroup>
      <EuiFlexItem>
        ...
        <div>
          {{#if (eq this.maxWidthType "bool")}}
            <Input @type="checkbox" @checked={{this.maxWidth}} name="maxwidth" />
            <label for="maxwidth">{{this.maxWidth}}</label>
          {{else if (eq this.maxWidthType "num")}}
            <label for="maxwidth">Enter value</label>
            <input type="number" value={{this.maxWidth}} {{on "input" this.parseToNum}} name="maxwidth" />
          {{else}}
            <label for="maxwidth">Enter value</label>
      ...
      <EuiFlexItem>
        ...
        <div>
          <Input @type="checkbox" @checked={{this.useOnClick}} name="useOnClick" />
        ...
        <div>
          <Input @type="checkbox" @checked={{this.isDisabled}} name="isDisabled" />
